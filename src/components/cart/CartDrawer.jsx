...
const CartLine = ({ item, onClose }) => {
  ...
  return (
    <li className="flex gap-3 rounded-3xl border border-line bg-card p-3 shadow-soft sm:gap-4">
      <Link
  ...
  if (coupon) {
    return (
      <div className="flex items-center gap-3 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3">
        <Tag size={15} className="shrink-0 text-emerald-600" />
...
export const CartDrawer = () => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100]">
      <div onClick={close} className="absolute inset-0 bg-dark/45 backdrop-blur-md" />
